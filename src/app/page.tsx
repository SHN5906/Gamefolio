...
import {
  Package, Target, Swords, Trophy, Wand2, Calendar,
  ArrowRight, ArrowUpRight, Sparkles, ShieldCheck,
} from 'lucide-react'
    ...
    <div className="min-h-screen relative" style={{ zIndex: 1 }}>
      ...
      >
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-7">
            <Link href="#features" className="text-[13px]" style={{ color: 'var(--color-text-secondary)' }}>Modes de jeu</Link>
            <Link href="#how" className="text-[13px]" style={{ color: 'var(--color-text-secondary)' }}>Comment ça marche</Link>
            <Link href="/pricing" className="text-[13px]" style={{ color: 'var(--color-text-secondary)' }}>VIP</Link>
            <Link href="#faq" className="text-[13px]" style={{ color: 'var(--color-text-secondary)' }}>FAQ</Link>
          </div>
      ...
      <section className="px-6 md:px-10 pt-16 md:pt-24 pb-16">
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            Le casino TCG en monnaie fictive. Ouvre des caisses, joue à la roue d&apos;upgrade,
            défie d&apos;autres joueurs en battle PvP. $10 offerts dès la création du compte.
          </p>
          ...
          <p className="text-[12px]" style={{ color: 'var(--color-text-muted)' }}>
            100% monnaie fictive · Aucune CB requise · 18+ · Conforme loi française
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto mt-16 relative">
          ...
          >
            ...
            <div className="flex items-center gap-2 px-4 py-3 border-b" style={{ borderColor: 'var(--color-border)' }}>
              ...
              <div className="flex-1 flex justify-center">
                ...
                >
                  ...
                  <span className="text-[10px]" style={{ color: 'var(--color-text-muted)' }}>gamefolio.app/game</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 md:p-7">
              ...
              <div className="rounded-[var(--radius-md)] border p-4 mb-4"
                style={{
                  background: 'linear-gradient(135deg, rgba(255,180,80,0.08) 0%, rgba(255,80,80,0.03) 100%)',
                  borderColor: 'var(--color-border-strong)',
                }}
              >
                ...
                <p className="text-[28px] md:text-[36px] font-extrabold leading-none"
                ...
                <p className="text-[12px] mt-1.5" style={{ color: 'var(--color-text-secondary)' }}>
                  Drake_Trainer · <span style={{ color: 'var(--color-pokemon-yellow)' }}>Dracaufeu Cristal PSA 10</span> · Caisse Skyridge
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 mb-4">
                {[
                  { emoji: '🔥', name: 'Kanto', price: '0,99 $', color: '#FF6B47' },
                  { emoji: '⚡', name: 'Néo Genesis', price: '2,49 $', color: '#FFCC00' },
                  { emoji: '💎', name: 'Cristaux', price: '14,99 $', color: '#00D4FF' },
                  { emoji: '👑', name: 'Gold Star', price: '49,99 $', color: '#FFD700' },
                ].map(c => (
                  <div key={c.name} className="rounded-[var(--radius-sm)] border p-3"
                    style={{
                  ...
                  >
                    ...
                    <p className="text-[10px] tabular-nums" style={{ fontFamily: 'var(--font-mono)', color: 'var(--color-positive)' }}>
                      {c.price}
                    </p>
                  </div>
                ))}
              ...
              >
                {[
                  { user: 'Sacha_X', card: 'Lugia Neo PSA 9',          value: '$1 240', up: true,  energy: 'colorless' },
                  { user: 'OakReborn', card: 'Mewtwo Star PSA 10',     value: '$3 100', up: true,  energy: 'psychic' },
                  { user: 'L33TJ4',   card: 'Rayquaza VMAX PSA 8',     value: '$420',   up: true,  energy: 'dragon' },
                ].map((w, i) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] font-semibold truncate" style={{ color: 'var(--color-text-primary)' }}>
                        <span style={{ color: 'var(--color-brand-hi)' }}>{w.user}</span> a ouvert {w.card}
                      </p>
                    </div>
                    <span className="text-[11px] font-bold" style={{ fontFamily: 'var(--font-mono)', color: 'var(--color-positive)' }}>
                      +{w.value}
                    </span>
                  </div>
                ))}
      ...
      <section className="px-6 md:px-10 py-12 border-y" style={{ borderColor: 'var(--color-border)' }}>
        <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[
            ...
            <div key={s.label}>
              <p className="text-[28px] md:text-[36px] font-extrabold leading-none mb-1"
                style={{ fontFamily: 'var(--font-display)', letterSpacing: '-0.025em', color: 'var(--color-text-primary)' }}
              >
                {s.value}
              </p>
              <p className="text-[11px] uppercase tracking-[1.5px]" style={{ color: 'var(--color-text-muted)' }}>
                {s.label}
              </p>
            </div>
          ))}
      ...
      <section id="features" className="px-6 md:px-10 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5">
            {[
              {
                icon: Package, title: 'Caisses thématiques',
      ...
      {/* ── HOW IT WORKS ────────────────────────────────────────── */}
      <section id="how" className="px-6 md:px-10 py-20 border-t" style={{ borderColor: 'var(--color-border)' }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-[10px] font-semibold uppercase tracking-[1.5px] mb-2" style={{ color: 'var(--color-brand-hi)' }}>
              Démarrer
          ...
          <div className="grid md:grid-cols-3 gap-5 max-w-4xl mx-auto">
            {[
              { num: '01', title: 'Crée ton compte', desc: 'Juste un email. Pas de CB, jamais. Vérification optionnelle.' },
              { num: '02', title: 'Récupère tes $10 offerts', desc: 'Crédités automatiquement. Si tu tombes à 0, cooldown 2h puis $5 rebonus.' },
              { num: '03', title: 'Ouvre ta première caisse', desc: 'Choisis ta caisse. La carte ET son grade PSA sont tirés au sort.' },
            ].map(({ num, title, desc }) => (
      ...
      <section className="px-6 md:px-10 py-16 border-t" style={{ borderColor: 'var(--color-border)' }}>
        <div className="max-w-4xl mx-auto rounded-[var(--radius-lg)] border p-8 md:p-10"
          style={{
            background: 'linear-gradient(135deg, rgba(16,217,140,0.06), rgba(11,15,26,0.4))',
            borderColor: 'var(--color-border-strong)',
          }}
        >
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-[var(--radius-sm)] flex items-center justify-center flex-shrink-0"
              style={{ background: 'var(--color-positive-soft)', color: 'var(--color-positive)' }}
            >
              <ShieldCheck size={20} strokeWidth={2} />
            </div>
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-[1.5px] mb-1.5" style={{ color: 'var(--color-positive)' }}>
                Provably fair · 100% monnaie fictive
              </p>
              <h3 className="text-[20px] md:text-[24px] font-extrabold tracking-tight leading-tight mb-3"
                style={{ fontFamily: 'var(--font-display)', letterSpacing: '-0.02em' }}
              >
                Aucun argent réel. Jamais.
              </h3>
              <p className="text-[14px] leading-relaxed mb-4" style={{ color: 'var(--color-text-secondary)' }}>
                GameFolio est un jeu en monnaie fictive uniquement. Tu ne peux ni déposer
                ni retirer d&apos;argent réel. Les cartes gagnées restent dans ton inventaire
                virtuel — elles ne peuvent pas être échangées contre des biens IRL.
                Chaque tirage est généré côté serveur avec un RNG cryptographique
                et est auditable.
              </p>
              <div className="flex flex-wrap gap-2">
                {['18+ uniquement', 'RNG côté serveur', 'Logs d\'audit', 'Conforme loi française', 'RGPD · EU'].map(b => (
                  <span key={b} className="px-2.5 py-1 rounded-full text-[10.5px] font-semibold border"
                    style={{
      ...
      {/* ── FAQ ─────────────────────────────────────────────────── */}
      <section id="faq" className="px-6 md:px-10 py-20 border-t" style={{ borderColor: 'var(--color-border)' }}>
        <div className="max-w-3xl mx-auto">
          <h2 className="text-[28px] md:text-[36px] font-extrabold tracking-tight mb-10 text-center"
            style={{ fontFamily: 'var(--font-display)', letterSpacing: '-0.025em' }}
          >
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <details key={i} className="group rounded-[var(--radius-md)] border p-4"
                style={{ background: 'var(--color-bg-glass)', borderColor: 'var(--color-border)' }}
              >
      ...
      <section className="px-6 md:px-10 py-20">
        ...
        >
          ...
          />
          <Sparkles size={28} strokeWidth={1.8} className="mx-auto mb-4" style={{ color: 'var(--color-pokemon-yellow)' }}/>
      ...
      <footer className="px-6 md:px-10 py-10 border-t" style={{ borderColor: 'var(--color-border)' }}>
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-5 text-[12px]">
            <Link href="/pricing" style={{ color: 'var(--color-text-muted)' }}>VIP</Link>
