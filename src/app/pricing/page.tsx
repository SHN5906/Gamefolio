...
export const metadata = {
  title: "VIP · GameFolio",
  description:
    "GameFolio est gratuit pour toujours. Les tiers VIP débloquent du cosmétique, du QoL et des bonus de wallet — strictement aucun pay-to-win.",
};
...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      {
        txt: "Effet lumineux sur le pseudo (leaderboard, battles, chat)",
        ok: true,
      },
  ...
  return (
    <div className="min-h-screen relative" style={{ zIndex: 1 }}>
      ...
      <section className="px-6 md:px-10 pt-16 md:pt-24 pb-12 text-center">
        ...
        <h1
          className="text-[40px] md:text-[56px] font-extrabold tracking-tight leading-tight mb-4"
          style={{
        ...
        >
          GameFolio est gratuit à 100%. Les tiers VIP donnent uniquement du
          cosmétique et un peu de QoL — aucun avantage de gameplay. Annulable en
          1 clic, sans engagement.
        </p>
      </section>
      ...
      <section className="px-6 md:px-10 pb-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-5">
          {PLANS.map((plan) => {
            const Icon =
              plan.id === "free" ? Sparkles : plan.id === "plus" ? Crown : Zap;
            return (
              <div
                key={plan.id}
      ...
      >
        <div className="max-w-3xl mx-auto">
          <h2
            className="text-[24px] md:text-[32px] font-extrabold tracking-tight mb-8 text-center"
            style={{
              fontFamily: "var(--font-display)",
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <details
                key={i}
                className="group rounded-[var(--radius-md)] border p-4 transition-colors"
                style={{
