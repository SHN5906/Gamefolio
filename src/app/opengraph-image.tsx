      ...
      >
        ...
        >
          <svg width="440" height="440" viewBox="0 0 120 120" fill="none">
            ...
            <polygon points={TOP_FACET}   fill="url(#t)" stroke="white" strokeWidth="1.4" />
            <polygon points={RIGHT_FACET} fill="url(#r)" stroke="white" strokeWidth="1.4" />
            <polygon points={LEFT_FACET}  fill="url(#l)" stroke="white" strokeWidth="1.4" />
            <g transform="translate(101.6,36)">
              <path d="M0,-9 L1.5,-1.5 L9,0 L1.5,1.5 L0,9 L-1.5,1.5 L-9,0 L-1.5,-1.5 Z" fill="white" />
