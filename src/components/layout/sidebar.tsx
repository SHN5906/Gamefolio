...
const FOOTER_NAV = [{ href: "/game/profile", icon: User, label: "Profil" }];
...
export function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo — prisme holographique */}
      <Link
        href="/game"
        className="flex items-center justify-center mb-4 flex-shrink-0 transition-transform hover:scale-110"
        title="GameFolio"
      >
        <LogoMark size={40} />
      </Link>
          ...
          return (
            <Link
              ...
              style={{
                ...
                boxShadow: isActive
                  ? "0 0 16px var(--color-brand-glow), inset 0 1px 0 rgba(255,255,255,0.05)"
                  : "none",
              }}
              onMouseEnter={(e) => {
                if (!isActive) {
