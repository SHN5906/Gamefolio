...
interface Win {
  ...
  grade: string
  value: number
  energy: 'fire' | 'water' | 'grass' | 'lightning' | 'psychic' | 'dark' | 'dragon' | 'colorless' | 'metal' | 'fairy'
}

const WINS: Win[] = [
  { user: 'Sacha_X',       initial: 'S', card: 'Lugia Neo',              grade: 'PSA 9',  value: 1240, energy: 'colorless' },
  { user: 'OakReborn',     initial: 'O', card: 'Mewtwo Star',            grade: 'PSA 10', value: 3100, energy: 'psychic' },
  { user: 'L33TJ4',        initial: 'L', card: 'Rayquaza VMAX',          grade: 'PSA 8',  value: 420,  energy: 'dragon' },
  { user: 'Drake_Trainer', initial: 'D', card: 'Dracaufeu Cristal',      grade: 'PSA 10', value: 4832, energy: 'fire' },
  { user: 'GemHunter',     initial: 'G', card: 'Mew Star δ',             grade: 'PSA 9',  value: 590,  energy: 'psychic' },
  { user: 'Eclair42',      initial: 'E', card: 'Pikachu Star',           grade: 'PSA 10', value: 720,  energy: 'lightning' },
  { user: 'NinjaTCG',      initial: 'N', card: 'Umbreon Star',           grade: 'PSA 9',  value: 1450, energy: 'dark' },
  { user: 'BrumeArt',      initial: 'B', card: 'Crystal Charizard',      grade: 'PSA 8',  value: 1800, energy: 'fire' },
  { user: 'Lulu',          initial: 'L', card: 'Reshiram & Charizard',   grade: 'PSA 10', value: 540,  energy: 'fire' },
  { user: 'Tomtom_92',     initial: 'T', card: 'Charizard VMAX',         grade: 'PSA 9',  value: 320,  energy: 'fire' },
  { user: 'JadePlume',     initial: 'J', card: 'Lugia Cristal',          grade: 'PSA 10', value: 2100, energy: 'colorless' },
  { user: 'KaedeFR',       initial: 'K', card: 'Espeon',                 grade: 'PSA 9',  value: 95,   energy: 'psychic' },
]
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(-90deg, #0A0E14 30%, transparent)' }}
      />
    </div>
  )
}
